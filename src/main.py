...
from utils import discretize_data, extract_action, sort_data, train_test_split
...
def extract_triples():
    ...
    for key, value in frames.items():
        ...
        for _, row in value.iterrows():
            ...
            action = URIRef(extract_action(row[ACTION]))
...
if __name__ == '__main__':
    # log_filename = "onto_extract_{}.log".format(
